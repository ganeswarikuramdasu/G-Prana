...
import com.gprana.dto.doctor.DoctorRequests.*;
import com.gprana.dto.hospital.HospitalRequests.AddDoctorRequest;
import com.gprana.entity.*;
import com.gprana.repository.*;
...
public class DoctorService {
    ...
    @Transactional
    public ApiResponse updateDoctorByHospital(com.gprana.dto.hospital.HospitalRequests.UpdateDoctorByHospitalRequest req) {
    ...
    @Transactional
    public ApiResponse approveDoctorAffiliation(com.gprana.dto.hospital.HospitalRequests.ApproveDoctorRequest req) {
    ...
    public ApiResponse accessPatientRecords(AccessRecordsRequest req) {
        ...
        if (cardRequested && !cardAuthorized) {
            ...
            throw ApiException.forbidden("Access permission is not given. The provided token is not an active patient access card. Scan a valid G-Prana Patient Access Card to open this patient's record.");
        }
        ...
        throw ApiException.forbidden(cardRequested
                ? "Access permission is not given. The provided token is not an active patient access card. Scan a valid G-Prana Patient Access Card to open this patient's record."
    ...
    public ApiResponse createAccessSession(AccessSessionsRequest req) {
        ...
        if (isCardMethod && !cardAuthorized) {
            recordAccessLogService.add(
                    ...
                    matchedCard == null
                            ? "Scanned token is not a recognized G-Prana Patient Access Card."
