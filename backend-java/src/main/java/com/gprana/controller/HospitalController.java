...
import com.gprana.dto.hospital.HospitalRequests.*;
import com.gprana.service.DoctorService;
import com.gprana.service.HospitalService;
...
public class HospitalController {
    ...
    public ApiResponse deleteDoctor(@RequestBody com.gprana.dto.admin.AdminRequests.DeleteDoctorRequest req) {
    ...
    public List<Map<String, Object>> getRecords(
            ...
            @RequestParam(name = "patientId", required = false) String patientId,
            @RequestParam(name = "gpranaHealthId", required = false) String gpranaHealthId,
        ...
        return hospitalService.getRecords(callerHospitalId, requestedHospitalId,
                ...
                gpranaHealthId, globalHealthId, patientHealthId, search);
    }
