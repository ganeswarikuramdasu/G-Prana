...
export const CompletePatientClinicalRecord: React.FC<CompletePatientClinicalRecordProps> = ({
  ...
  // Guard against double-submit of clinical forms
  ...
  const getAccessMethodDisplay = () => {
    switch (accessMethod) {
      case "APPOINTMENT":
        return { label: "Accessed Via: Scheduled Appointment", color: "bg-[#E9FBF1] text-[#17C964] border-[#17C964]/40", icon: Calendar };
      case "PATIENT_ACCESS_CARD":
      case "ACCESS_CARD":
        return { label: "Accessed Via: Patient Access Card / QR", color: "bg-[#E9FBF1] text-[#17C964] border-[#17C964]/40", icon: FileSpreadsheet };
      case "BIOMETRIC":
      case "FACE_SCAN":
        return { label: "Accessed Via: Biometric Verification", color: "bg-[#E9FBF1] text-[#17C964] border-[#17C964]/40", icon: ShieldCheck };
      case "EMERGENCY_BREAK_GLASS":
      case "EMERGENCY":
        return { label: "Accessed Via: Emergency Break-Glass", color: "bg-[#FDECE8] text-[#E23A2E] border-[#F2603C]/40", icon: Siren };
      case "PATIENT_AUTHORIZATION":
        return { label: "Accessed Via: Patient Assisted Authorization", color: "bg-[#E9FBF1] text-[#17C964] border-[#17C964]/40", icon: ShieldCheck };
      default:
        return { label: "Accessed Via: Patient Health ID Lookup", color: "bg-[#E9FBF1] text-[#17C964] border-[#17C964]/40", icon: User };
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <button
          onClick={onBack}
          className="inline-flex items-center space-x-2 px-3.5 py-2 bg-slate-100/80 hover:bg-slate-700 text-slate-800 text-xs font-semibold rounded-xl border border-slate-300 transition"
        >
      ...
      {(accessMethod === "EMERGENCY_BREAK_GLASS" || accessMethod === "EMERGENCY" || accessSession?.emergencySessionId) && !sessionEnded && (
        <div className="bg-gradient-to-r from-[#7F1D13] via-[#A63A2C] to-[#3A1410] border-2 border-[#F2603C]/80 rounded-3xl p-5 shadow-2xl space-y-3">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div className="flex items-start space-x-3">
              <div className="p-2.5 bg-[#F2603C]/20 border border-[#F2603C]/40 rounded-2xl shrink-0 mt-0.5">
                <Siren className="w-6 h-6 text-[#F2603C] animate-bounce" />
              </div>
              <div>
                <div className="flex items-center space-x-2">
                  <span className="px-2.5 py-0.5 bg-[#F2603C] text-white font-mono font-black text-[10px] rounded uppercase tracking-wider">
                    EMERGENCY ACCESS ACTIVE
                  </span>
                  <span className="text-xs font-mono text-[#F8B4A8]">
                ...
                <p className="text-xs text-[#FAD9D0] mt-0.5 max-w-2xl leading-relaxed">
            ...
            <button
              ...
              className="px-5 py-2.5 bg-gradient-to-r from-[#F2603C] to-[#E23A2E] hover:from-[#E23A2E] hover:to-[#C22A1E] text-white font-bold text-xs rounded-xl shadow-lg shadow-[#F2603C]/40 border border-[#F2603C]/40 transition shrink-0 flex items-center space-x-2"
            >
      ...
      <div className="bg-[#FFFFFF] border border-slate-200 rounded-3xl p-6 shadow-xl space-y-5">
        <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between gap-6 border-b border-slate-200/80 pb-5">
          {/* Patient Info */}
          <div className="flex items-center space-x-4">
            <div className="w-16 h-16 rounded-2xl bg-gradient-to-tr from-[#17C964] via-[#0f172a] to-[#17C964] border border-[#17C964]/40 flex items-center justify-center text-white font-black text-xl shadow-lg shrink-0">
              {patient.name ? patient.name.charAt(0) : "P"}
            </div>
            <div>
              <div className="flex items-center space-x-3">
                <h2 className="text-2xl font-black text-slate-900 tracking-tight">{patient.name || "Patient Citizen"}</h2>
                <span className="px-2.5 py-0.5 bg-[#E9FBF1] border border-[#17C964]/40 text-[#17C964] text-xs font-mono font-bold rounded-md">
              ...
              <div className="flex flex-wrap items-center gap-3 text-xs text-slate-500 font-mono mt-1">
                <span>Health ID: <strong className="text-[#17C964]">{patient.globalHealthId}</strong></span>
                <span>•</span>
                <span>Blood Group: <strong className="text-[#E23A2E]">{patient.bloodGroup || "B+"}</strong></span>
                <span>•</span>
          ...
          <div className="flex flex-wrap items-center gap-2.5 shrink-0">
            <button
              ...
              className="px-3.5 py-2 bg-[#17C964] hover:bg-[#0EA653] text-white text-xs font-bold rounded-xl shadow-lg shadow-[#17C964]/30 transition flex items-center space-x-1.5"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-3 text-xs">
          {/* Allergies */}
          <div className="bg-[#EDF1F5] border border-[#F2603C]/30 rounded-2xl p-3.5 space-y-1">
            <div className="flex items-center space-x-1.5 text-[#E23A2E] font-bold uppercase text-[10px] tracking-wider">
          ...
          {/* Chronic Conditions */}
          <div className="bg-[#EDF1F5] border border-[#17C964]/30 rounded-2xl p-3.5 space-y-1">
            <div className="flex items-center space-x-1.5 text-[#17C964] font-bold uppercase text-[10px] tracking-wider">
          ...
          {/* Latest BP & HR */}
          <div className="bg-[#EDF1F5] border border-slate-200 rounded-2xl p-3.5 space-y-1">
            <div className="flex items-center space-x-1.5 text-[#17C964] font-bold uppercase text-[10px] tracking-wider">
          ...
          return (
            <button
              ...
              className={`flex items-center space-x-2 px-3.5 py-2.5 rounded-xl font-bold text-xs whitespace-nowrap transition ${
                isActive
                  ? "bg-[#17C964] text-white shadow-lg shadow-[#17C964]/30"
            ...
            >
              ...
              <span>{tab.label}</span>
              {tab.count !== undefined && (
                <span className="px-1.5 py-0.5 bg-slate-100 text-[#17C964] font-mono text-[10px] rounded-full">
                  {tab.count}
                </span>
              )}
            </button>
      ...
      {activeTab === "OVERVIEW" && (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-[#FFFFFF] border border-slate-200 rounded-3xl p-5 space-y-4">
            ...
            <div className="space-y-2.5 text-xs">
              <div className="flex justify-between py-1.5 border-b border-slate-200">
                ...
                <span className="text-slate-800 font-medium">{patient.name || "Patient"}</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-slate-200">
                <span className="text-slate-500">Global Health ID</span>
                <span className="text-[#17C964] font-mono font-bold">{patient.globalHealthId}</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-slate-200">
                <span className="text-slate-500">Date of Birth</span>
                <span className="text-slate-800 font-medium">{patient.dob || "1995-04-12"}</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-slate-200">
                <span className="text-slate-500">Gender & Blood Group</span>
                <span className="text-slate-800 font-medium">{patient.gender || "Female"} | {patient.bloodGroup || "B+"}</span>
              </div>
              <div className="flex justify-between py-1.5 border-b border-slate-200">
                <span className="text-slate-500">Insurance Provider</span>
                <span className="text-slate-800 font-medium">{patient.insuranceProvider || "Universal Health Guard"}</span>
              </div>
              <div className="flex justify-between py-1.5">
                <span className="text-slate-500">Policy Number</span>
                <span className="text-slate-700 font-mono">{patient.insurancePolicyNumber || ""}</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#FFFFFF] border border-slate-200 rounded-3xl p-5 space-y-4">
            ...
            <div className="space-y-3 text-xs">
              <div className="p-3 bg-[#EDF1F5] border border-slate-200 rounded-2xl space-y-1">
                <div className="flex justify-between font-bold text-slate-900">
                  <span>{patient.emergencyContactName || "Vikram Sharma"}</span>
                  <span className="text-[#17C964] text-[10px] font-mono border border-[#17C964]/40 px-2 py-0.5 rounded">PRIMARY</span>
                </div>
                <div className="text-slate-500">Relation: {patient.emergencyContactRelation || "Brother"}</div>
                <div className="text-[#17C964] font-mono">{patient.emergencyContactPhone || "+91 98765 43210"}</div>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* 2. EMERGENCY PROFILE */}
      {activeTab === "EMERGENCY" && (
        <div className="bg-[#FFFFFF] border border-slate-200 rounded-3xl p-6 space-y-5">
          <div className="flex items-center justify-between border-b border-slate-200 pb-4">
            <h3 className="font-bold text-slate-900 text-base flex items-center space-x-2">
              <Siren className="w-5 h-5 text-[#E23A2E]" />
              <span>Emergency Health Profile & Triage Info</span>
            </h3>
            <span className="px-2.5 py-1 bg-[#FDECE8] border border-[#F2603C]/40 text-[#E23A2E] text-xs font-mono rounded-lg">
              VERIFIED EMERGENCY LEDGER
            </span>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
            <div className="bg-[#EDF1F5] border border-[#F2603C]/30 p-4 rounded-2xl space-y-2">
              <span className="text-[#E23A2E] font-bold uppercase text-[10px]">CRITICAL ALLERGIES</span>
              <p className="text-slate-800 font-medium text-sm">{(patient.allergies || ["Penicillin", "Dust Mites", "NSAIDs"]).join(", ")}</p>
            </div>
            <div className="bg-[#EDF1F5] border border-[#17C964]/30 p-4 rounded-2xl space-y-2">
              <span className="text-[#17C964] font-bold uppercase text-[10px]">CHRONIC CONDITIONS</span>
              <p className="text-slate-800 font-medium text-sm">{(patient.chronicConditions || ["Mild Allergic Asthma"]).join(", ")}</p>
            </div>
            <div className="bg-[#EDF1F5] border border-[#17C964]/30 p-4 rounded-2xl space-y-2">
              <span className="text-[#17C964] font-bold uppercase text-[10px]">CURRENT MEDICATIONS</span>
              <p className="text-slate-800 font-medium text-sm">Levosalbutamol Inhaler 100mcg (As Needed)</p>
            </div>
          </div>

          <div className="p-4 bg-[#FDECE8] border border-[#F2603C]/30 rounded-2xl text-xs space-y-1">
            <span className="font-bold text-[#E23A2E] uppercase text-[10px] tracking-wider">Emergency Triage Directives</span>
      ...
      {activeTab === "VITALS" && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="font-bold text-slate-900 text-sm flex items-center space-x-2">
              <Activity className="w-4 h-4 text-[#17C964]" />
              <span>Vital Signs History ({vitalsList.length} Recordings)</span>
            </h3>
            <button
              onClick={() => setShowAddVitalModal(true)}
              className="px-3 py-1.5 bg-[#17C964] hover:bg-[#0EA653] text-white text-xs font-bold rounded-xl transition flex items-center space-x-1"
            >
          ...
          <div className="space-y-3">
            {vitalsList.map((v) => (
              <div key={v.id} className="bg-[#FFFFFF] border border-slate-200 rounded-2xl p-4 flex flex-col md:flex-row md:items-center justify-between gap-4 text-xs">
                <div>
                  <div className="flex items-center space-x-2 font-mono text-slate-500">
                    ...
                    <span>•</span>
                    <span className="text-slate-700 font-bold">{v.doctorName}</span>
                  </div>
                  {v.notes && <p className="text-slate-700 mt-1 italic">"{v.notes}"</p>}
                </div>

                <div className="grid grid-cols-3 md:grid-cols-6 gap-2 font-mono text-center shrink-0">
                  <div className="bg-[#EDF1F5] p-2 rounded-xl border border-slate-200">
                    <span className="text-[9px] text-slate-500 block">BP</span>
                    <span className="text-[#17C964] font-bold">{v.bp}</span>
                  </div>
                  <div className="bg-[#EDF1F5] p-2 rounded-xl border border-slate-200">
                    <span className="text-[9px] text-slate-500 block">HR</span>
                    <span className="text-[#E23A2E] font-bold">{v.heartRate} bpm</span>
                  </div>
                  <div className="bg-[#EDF1F5] p-2 rounded-xl border border-slate-200">
                    <span className="text-[9px] text-slate-500 block">SpO2</span>
                    <span className="text-[#17C964] font-bold">{v.spo2}%</span>
                  </div>
                  <div className="bg-[#EDF1F5] p-2 rounded-xl border border-slate-200">
                    <span className="text-[9px] text-slate-500 block">TEMP</span>
                    <span className="text-[#17C964] font-bold">{v.temp} F</span>
                  </div>
                  <div className="bg-[#EDF1F5] p-2 rounded-xl border border-slate-200">
                    <span className="text-[9px] text-slate-500 block">WEIGHT</span>
                    <span className="text-[#17C964] font-bold">{v.weight} kg</span>
                  </div>
                  <div className="bg-[#EDF1F5] p-2 rounded-xl border border-slate-200">
                    <span className="text-[9px] text-slate-500 block">GLUCOSE</span>
                    <span className="text-[#17C964] font-bold">{v.glucose} mg/dL</span>
                  </div>
                </div>
              </div>
            ))}
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-4">
            {medicalRecords.length === 0 ? (
              <div className="bg-[#FFFFFF] border border-slate-200 rounded-2xl p-8 text-center text-slate-500 text-xs">
                No clinical notes recorded yet. Click above to add a new note.
              </div>
            ) : (
              medicalRecords.map((r) => (
                <div key={r.id} className="bg-[#FFFFFF] border border-slate-200 rounded-3xl p-5 space-y-3 text-xs">
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-2 border-b border-slate-200 pb-3">
                    <div>
                      <span className="px-2 py-0.5 bg-[#E9FBF1] border border-[#17C964]/40 text-[#17C964] font-mono text-[10px] rounded uppercase">
                  ...
                  <div className="space-y-1.5">
                    <div><strong className="text-[#17C964]">Diagnosis:</strong> <span className="text-slate-800">{r.diagnosis}</span></div>
                    {r.symptoms && r.symptoms.length > 0 && (
                      <div><strong className="text-[#17C964]">Symptoms:</strong> <span className="text-slate-700">{r.symptoms.join(", ")}</span></div>
                    )}
                    <div className="p-3 bg-[#EDF1F5] rounded-2xl border border-slate-200 text-slate-700 leading-relaxed whitespace-pre-line">
                      {r.doctorNotes}
                    </div>
                  </div>

                  {r.doctorSignature && (
                    <div className="text-[10px] text-[#17C964] font-mono pt-1">
      ...
      {activeTab === "LABS" && (
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="font-bold text-slate-900 text-sm flex items-center space-x-2">
              <FlaskConical className="w-4 h-4 text-[#17C964]" />
              <span>Laboratory & Diagnostic Panel Reports</span>
            </h3>
            <button
              onClick={() => setShowUploadLabModal(true)}
              className="px-3.5 py-2 bg-[#17C964] hover:bg-[#0EA653] text-white text-xs font-bold rounded-xl transition flex items-center space-x-1.5 shadow-lg shadow-[#17C964]/20"
            >
          ...
          {medicalRecords.filter(r => r.recordType === "LAB_REPORT" || r.recordType === "IMAGING_SCAN" || r.category === "LAB_REPORT").length > 0 && (
            <div className="space-y-3">
              <h4 className="font-bold text-slate-700 text-xs font-mono uppercase">Uploaded Reports for {patient.name}</h4>
              {medicalRecords.filter(r => r.recordType === "LAB_REPORT" || r.recordType === "IMAGING_SCAN" || r.category === "LAB_REPORT").map((lab) => (
                <div key={lab.id} className="bg-[#FFFFFF] border border-slate-200 hover:border-[#17C964]/40 rounded-3xl p-5 space-y-3 text-xs shadow-md">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 border-b border-slate-200 pb-3">
                    <div>
                      <div className="flex items-center space-x-2">
                        <span className="px-2 py-0.5 bg-[#E9FBF1] border border-[#17C964]/40 text-[#17C964] font-mono text-[10px] rounded uppercase font-bold">
                          {lab.testCategory || lab.recordType || "LAB_REPORT"}
                        </span>
                        <span className="text-slate-500 font-mono text-[11px]">{lab.date}</span>
                      </div>
                      <h4 className="text-sm font-bold text-slate-900 mt-1">{lab.testName || lab.title}</h4>
                      <p className="text-slate-500 text-[11px]">Laboratory: {lab.hospitalName || "Central Diagnostic Labs"}</p>
                    </div>

                    <div className="flex items-center space-x-2">
                      <button
                        onClick={() => alert(`Opening secure document view for ${lab.fileName || lab.title}...`)}
                        className="px-3 py-1.5 bg-[#EDF1F5] border border-slate-300 hover:border-[#17C964] text-[#17C964] font-bold rounded-xl transition flex items-center space-x-1"
                      >
                  ...
                  <div className="space-y-2">
                    ...
                    {lab.diagnosis && (
                      <div className="p-2.5 bg-[#EDF1F5] rounded-2xl border border-slate-200">
                        ...
                        <span className="text-slate-800">{lab.diagnosis}</span>
                      </div>
                    )}
                    {lab.doctorNotes && (
                      <div className="text-slate-700 font-sans italic text-[11px]">
          ...
          <div className="bg-[#FFFFFF] border border-slate-200 rounded-3xl p-5 space-y-4 text-xs">
            <div className="border-b border-slate-200 pb-3 flex justify-between items-center">
              <div>
                <h4 className="font-bold text-slate-900 text-sm">Executive Cardiovascular & Fasting Metabolic Panel</h4>
                <p className="text-slate-500 text-[11px]">Lab: Central Diagnostic Labs • Date: 2026-08-06</p>
              </div>
              <span className="px-2.5 py-1 bg-[#E9FBF1] border border-[#17C964]/40 text-[#17C964] font-mono text-[10px] rounded">
                VERIFIED FINAL
              </span>
            </div>
            ...
            <div className="space-y-2">
              {[
                ...
                <div key={idx} className="flex justify-between items-center p-2.5 bg-[#EDF1F5] rounded-xl border border-slate-200">
                  <span className="font-medium text-slate-900">{t.test}</span>
                  <div className="flex items-center space-x-3 font-mono">
                    <span className="text-slate-500 text-[11px]">Ref: {t.ref}</span>
                    <span className="text-slate-900 font-bold">{t.result}</span>
                    <span className={`px-2 py-0.5 text-[10px] rounded font-bold ${t.status === "HIGH" ? "bg-[#FDECE8] text-[#E23A2E] border border-[#F2603C]/40" : "bg-[#E9FBF1] text-[#17C964] border border-[#17C964]/40"}`}>
                      {t.status}
                    </span>
                  </div>
                </div>
      ...
      {activeTab === "MEDICATIONS_PRESCRIPTIONS" && (
        <div className="space-y-5">
          ...
          <div className="bg-[#FFFFFF] border border-slate-200 rounded-3xl p-4 grid grid-cols-1 md:grid-cols-3 gap-4 text-xs">
            <div className="bg-[#EDF1F5] border border-[#17C964]/30 rounded-2xl p-3.5 flex items-center justify-between">
              <div>
                <span className="text-slate-500 text-[11px] block font-medium">Today's Patient Adherence</span>
                <span className="text-[#17C964] font-bold text-lg font-mono">{adherenceSummary.todayTaken} / {adherenceSummary.todayTotal || activeMedications.length} Doses</span>
              </div>
              <div className="w-10 h-10 rounded-xl bg-[#E9FBF1] border border-[#17C964]/40 flex items-center justify-center text-[#17C964] font-bold font-mono">
            ...
            <div className="bg-[#EDF1F5] border border-[#17C964]/30 rounded-2xl p-3.5 flex items-center justify-between">
              <div>
                <span className="text-slate-500 text-[11px] block font-medium">7-Day Adherence Average</span>
                <span className="text-[#17C964] font-bold text-lg font-mono">{adherenceSummary.last7DaysPercentage}% Compliance</span>
              </div>
              <div className="w-10 h-10 rounded-xl bg-[#E9FBF1] border border-[#17C964]/40 flex items-center justify-center text-[#17C964]">
            ...
            <div className="bg-[#EDF1F5] border border-[#17C964]/30 rounded-2xl p-3.5 flex items-center justify-between">
              <div>
                <span className="text-slate-500 text-[11px] block font-medium">Active Prescriptions</span>
                <span className="text-[#17C964] font-bold text-lg font-mono">{activeMedications.length} Active Meds</span>
              </div>
              <div className="w-10 h-10 rounded-xl bg-[#E9FBF1] border border-[#17C964]/40 flex items-center justify-center text-[#17C964]">
          ...
          <div className="bg-[#FFFFFF] border border-slate-200 rounded-3xl p-5 space-y-4 text-xs">
            <div className="flex items-center justify-between border-b border-slate-200 pb-3">
              ...
              <span className="text-slate-500 font-mono text-[11px]">Managed by Prescribing Doctors</span>
            </div>

            {isLoadingMeds ? (
              <div className="p-6 text-center text-slate-500">Loading clinical medication records...</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {activeMedications.map((m) => (
                  <div
                    key={m.id}
                    className="p-4 bg-[#EDF1F5] border border-slate-200 hover:border-[#17C964]/40 rounded-2xl space-y-3 transition flex flex-col justify-between"
                  >
                    <div className="space-y-2">
                      <div className="flex items-start justify-between gap-2">
                        <div>
                          <div className="flex items-center space-x-2">
                            <span className="font-bold text-slate-900 text-base">{m.medicationName}</span>
                            {m.genericName && (
                              <span className="text-slate-500 text-[11px]">({m.genericName})</span>
                            )}
                          </div>
                          <p className="text-[#17C964] font-mono font-bold text-xs mt-0.5">
                            {m.dosage} {m.unit || ""} • {m.frequency} • {m.route || "Oral"}
                          </p>
                        </div>
                        <span className="px-2.5 py-1 bg-[#E9FBF1] border border-[#17C964]/40 text-[#17C964] font-mono text-[10px] font-bold rounded-lg shrink-0">
                          ACTIVE
                        </span>
                      </div>

                      <div className="space-y-1 text-[11px] text-slate-700 bg-[#FFFFFF] p-3 rounded-xl border border-slate-200">
                        {m.timing && (
                          <div><strong className="text-slate-500">Timing:</strong> {m.timing}</div>
                        )}
                        <div><strong className="text-slate-500">Duration:</strong> {m.startDate} → {m.endDate} ({m.duration || "Ongoing"})</div>
                        {m.indication && (
                          <div><strong className="text-slate-500">Indication:</strong> {m.indication}</div>
                        )}
                        {m.instructions && (
                          <div><strong className="text-slate-500">Instructions:</strong> {m.instructions}</div>
                        )}
                        <div className="text-slate-500 text-[10px] pt-1 border-t border-slate-200/80 font-mono">
                          Prescribed By: <span className="text-[#17C964]">{m.doctorName}</span> ({m.hospitalName || "Apollo Multi-Specialty Hospital"})
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center justify-end space-x-2 pt-2 border-t border-slate-200/80">
                      <button
                        ...
                        className="px-3 py-1.5 bg-[#FDECE8] hover:bg-[#FADBD2] border border-[#F2603C]/40 text-[#E23A2E] font-bold text-[11px] rounded-xl transition flex items-center space-x-1"
                      >
          ...
          <div className="bg-[#FFFFFF] border border-slate-200 rounded-3xl p-5 space-y-3 text-xs">
            <h4 className="font-bold text-slate-900 text-sm flex items-center space-x-2 border-b border-slate-200 pb-3">
            ...
            {medicationHistory.length === 0 ? (
              ...
              <div className="space-y-2.5">
                {medicationHistory.map((m) => (
                  <div
                    key={m.id}
                    className="p-3.5 bg-[#EDF1F5] border border-slate-200/80 rounded-2xl flex flex-col md:flex-row md:items-center justify-between gap-3 text-xs"
                  >
                    <div>
                      <div className="flex items-center space-x-2">
                        <span className="font-bold text-slate-900">{m.medicationName}</span>
                        <span className="text-slate-500 text-[11px] font-mono">{m.dosage} • {m.frequency}</span>
                        <span className="px-2 py-0.5 bg-[#FDECE8] border border-[#F2603C]/40 text-[#E23A2E] font-mono text-[9px] rounded font-bold">
                          {m.status}
                        </span>
                      </div>
                      ...
                      {m.discontinuationReason && (
                        <div className="mt-1.5 p-2 bg-[#FDECE8] border border-[#F2603C]/30 rounded-xl text-[#E23A2E] text-[11px]">
          ...
          <div className="space-y-2.5">
            <div className="p-3 bg-[#EDF1F5] border border-slate-200 rounded-2xl space-y-1">
              <div className="flex justify-between font-bold text-slate-900">
                ...
                <span className="text-slate-500 font-mono text-[11px]">Diagnosed 2022</span>
              </div>
              <p className="text-slate-700">Managed via bronchodilator inhalers during seasonal air changes.</p>
            </div>
            <div className="p-3 bg-[#EDF1F5] border border-slate-200 rounded-2xl space-y-1">
              <div className="flex justify-between font-bold text-slate-900">
                <span>Seasonal Sinusitis</span>
                <span className="text-slate-500 font-mono text-[11px]">Diagnosed 2024</span>
              </div>
              <p className="text-slate-700">Periodic nasal congestion during winter transitions.</p>
            </div>
          </div>
        </div>
      )}
      ...
      {showAddMedicationModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#FFFFFF] border border-slate-200 rounded-3xl max-w-2xl w-full p-6 shadow-2xl space-y-4 text-xs max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center border-b border-slate-200 pb-3">
              <h3 className="font-bold text-slate-900 text-base flex items-center space-x-2">
                <Pill className="w-5 h-5 text-[#17C964]" />
                <span>Add Clinical Medication Record</span>
              </h3>
              <button onClick={() => setShowAddMedicationModal(false)} className="text-slate-500 hover:text-slate-900">✕</button>
            </div>

            <form onSubmit={handleSaveMedication} className="space-y-3">
              {/* Patient Read-only Header */}
              <div className="p-3 bg-[#EDF1F5] border border-slate-200 rounded-2xl grid grid-cols-2 gap-2 text-slate-700">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-slate-500 block mb-1">Medication Name *</label>
                  <input
                    type="text"
                    placeholder="e.g. Metformin"
                    value={medName}
                    onChange={(e) => setMedName(e.target.value)}
                    className="w-full bg-[#EDF1F5] border border-slate-200 rounded-xl px-3 py-2 text-slate-900 font-bold"
                    required
                  />
                </div>
                <div>
                  <label className="text-slate-500 block mb-1">Generic Name</label>
                  <input
                    type="text"
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  <label className="text-slate-500 block mb-1">Dosage *</label>
                  <input
                    type="text"
                    placeholder="e.g. 500"
                    value={dosage}
                ...
                <div>
                  <label className="text-slate-500 block mb-1">Frequency *</label>
                  <select
                    value={frequency}
              ...
              <div className="grid grid-cols-3 gap-3">
                <div>
                  <label className="text-slate-500 block mb-1">Route</label>
                  <select
                    value={route}
                ...
                <div>
                  <label className="text-slate-500 block mb-1">Timing</label>
                  <input
                    type="text"
              ...
              <div>
                <label className="text-slate-500 block mb-1">Clinical Indication / Reason</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-slate-500 block mb-1">Patient Instructions</label>
                <textarea
                  value={instructions}
                  onChange={(e) => setInstructions(e.target.value)}
                  placeholder="e.g. Take strictly after meals with water."
                  className="w-full bg-[#EDF1F5] border border-slate-200 rounded-xl px-3 py-2 text-slate-900 h-16"
                />
              </div>
              ...
              <div className="flex justify-end space-x-2 pt-3">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 bg-[#17C964] hover:bg-[#0EA653] text-white font-bold rounded-xl shadow-lg shadow-[#17C964]/30"
                >
      ...
      {discontinuingMedication && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#FFFFFF] border border-[#F2603C]/40 rounded-3xl max-w-lg w-full p-6 shadow-2xl space-y-4 text-xs">
            <div className="flex justify-between items-center border-b border-slate-200 pb-3">
              <h3 className="font-bold text-slate-900 text-base flex items-center space-x-2">
                <XCircle className="w-5 h-5 text-[#E23A2E]" />
                <span>Discontinue Medication: {discontinuingMedication.medicationName}</span>
              </h3>
              <button onClick={() => setDiscontinuingMedication(null)} className="text-slate-500 hover:text-slate-900">✕</button>
            </div>

            <form onSubmit={handleDiscontinueMedication} className="space-y-3">
              <div className="p-3 bg-[#EDF1F5] border border-slate-200 rounded-2xl text-slate-700 space-y-1">
              ...
              <div>
                <label className="text-[#E23A2E] font-bold block mb-1">
                ...
                <textarea
                  ...
                  className="w-full bg-[#EDF1F5] border border-[#F2603C]/40 focus:border-[#F2603C] rounded-xl px-3 py-2 text-slate-900 h-24"
                  required
                />
              </div>

              <div className="p-3 bg-[#FDECE8] border border-[#F2603C]/30 rounded-xl text-[#E23A2E] text-[11px] flex items-center space-x-2">
                <AlertCircle className="w-4 h-4 shrink-0 text-[#E23A2E]" />
              ...
              <div className="flex justify-end space-x-2 pt-2">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 bg-[#F2603C] hover:bg-[#E23A2E] text-white font-bold rounded-xl shadow-lg shadow-[#F2603C]/40"
                >
                  Confirm Discontinue
                </button>
              </div>
      ...
      {showAddVitalModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#FFFFFF] border border-slate-200 rounded-3xl max-w-lg w-full p-6 shadow-2xl space-y-4 text-xs">
            <div className="flex justify-between items-center border-b border-slate-200 pb-3">
              <h3 className="font-bold text-slate-900 text-base flex items-center space-x-2">
                <Activity className="w-5 h-5 text-[#17C964]" />
                <span>Record New Vital Signs</span>
              </h3>
              <button onClick={() => setShowAddVitalModal(false)} className="text-slate-500 hover:text-slate-900">✕</button>
            </div>

            <form onSubmit={handleSaveVitals} className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-slate-500 block mb-1">Blood Pressure (mmHg)</label>
                  <input
                    type="text"
                    value={newBp}
                ...
                <div>
                  <label className="text-slate-500 block mb-1">Heart Rate (bpm)</label>
                  <input
                    type="text"
                    value={newHeartRate}
                ...
                <div>
                  <label className="text-slate-500 block mb-1">Oxygen SpO2 (%)</label>
                  <input
                    type="text"
                    value={newSpo2}
                ...
                <div>
                  <label className="text-slate-500 block mb-1">Temperature (°F)</label>
                  <input
                    type="text"
                    value={newTemp}
                ...
                <div>
                  <label className="text-slate-500 block mb-1">Weight (kg)</label>
                  <input
                    type="text"
                    value={newWeight}
                ...
                <div>
                  <label className="text-slate-500 block mb-1">Glucose (mg/dL)</label>
                  <input
                    type="text"
                    value={newGlucose}
              ...
              <div>
                <label className="text-slate-500 block mb-1">Clinical Observation Notes</label>
                <textarea
                  value={vitalNotes}
                  onChange={(e) => setVitalNotes(e.target.value)}
                  placeholder="Optional notes on vital measurements..."
                  className="w-full bg-[#EDF1F5] border border-slate-200 rounded-xl px-3 py-2 text-slate-900 h-20"
                />
              </div>
              ...
              <div className="flex justify-end space-x-2 pt-2">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-[#17C964] hover:bg-[#0EA653] text-white font-bold rounded-xl disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {savingAction ? "Saving..." : "Save & Timestamp Vitals"}
                </button>
              </div>
            </form>
          </div>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#FFFFFF] border border-slate-200 rounded-3xl max-w-2xl w-full p-6 shadow-2xl space-y-4 text-xs max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center border-b border-slate-200 pb-3">
              ...
              <button onClick={() => setShowAddNoteModal(false)} className="text-slate-500 hover:text-slate-900">✕</button>
            </div>

            <form onSubmit={handleSaveNote} className="space-y-3">
              <div>
                <label className="text-slate-500 block mb-1">Note Title</label>
                <input
                  type="text"
                  value={noteTitle}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-slate-500 block mb-1">Diagnosis</label>
                  <input
                    type="text"
                    value={diagnosis}
                ...
                <div>
                  <label className="text-slate-500 block mb-1">Chief Symptoms</label>
                  <input
                    type="text"
                    value={symptoms}
              ...
              <div>
                <label className="text-slate-500 block mb-1">Chief Complaint & History</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-slate-500 block mb-1">Clinical Observations & Physical Assessment</label>
                <textarea
                  value={observations}
              ...
              <div>
                <label className="text-slate-500 block mb-1">Treatment Plan & Follow-Up Advice</label>
                <textarea
                  value={treatmentPlan}
              ...
              <div className="flex justify-end space-x-2 pt-2">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-[#17C964] hover:bg-[#0EA653] text-white font-bold rounded-xl disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {savingAction ? "Saving..." : "Digitally Sign & Append Note"}
                </button>
              </div>
            </form>
          </div>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#FFFFFF] border border-slate-200 rounded-3xl max-w-2xl w-full p-6 shadow-2xl space-y-4 text-xs max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center border-b border-slate-200 pb-3">
              ...
              <button onClick={() => setShowAddPrescriptionModal(false)} className="text-slate-500 hover:text-slate-900">✕</button>
            </div>

            <form onSubmit={handleSavePrescription} className="space-y-4">
              <div>
                <label className="text-slate-500 block mb-1">Diagnosis / Indication</label>
                <input
                  type="text"
                  value={rxDiagnosis}
              ...
              {/* Medicines List */}
              <div className="space-y-2">
                <label className="text-slate-500 font-bold block">Prescribed Medicines</label>
                {rxMedicines.map((m, idx) => (
                  <div key={idx} className="p-3 bg-[#EDF1F5] border border-slate-200 rounded-2xl grid grid-cols-1 md:grid-cols-4 gap-2">
                    <input
                      type="text"
                      ...
                      className="bg-[#FFFFFF] border border-slate-200 rounded-xl px-2.5 py-1.5 text-slate-900"
                      required
                    />
                    <input
                      type="text"
                ...
                <button
                  ...
                  className="text-[#17C964] font-bold hover:underline text-[11px] flex items-center space-x-1"
                >
              ...
              {/* AI Safety Check */}
              <div className="p-3 bg-[#E9FBF1] border border-[#17C964]/40 rounded-2xl space-y-2">
                <div className="flex items-center justify-between">
                  <span className="font-bold text-[#17C964] flex items-center space-x-1.5">
                  ...
                  <button
                    ...
                    className="px-3 py-1 bg-[#17C964] hover:bg-[#0EA653] text-white font-bold rounded-lg text-[10px]"
                  >
                    {isAiChecking ? "Analyzing..." : "Run Safety Check"}
                  </button>
                </div>
                {aiCheckStatus && <p className="text-[#17C964] text-[11px]">{aiCheckStatus}</p>}
              </div>
              ...
              <div className="flex justify-end space-x-2 pt-2">
                ...
                <button
                  ...
                  className="px-5 py-2 bg-[#17C964] hover:bg-[#0EA653] text-white font-bold rounded-xl disabled:opacity-60 disabled:cursor-not-allowed"
                >
                  {savingAction ? "Saving..." : "Digitally Sign & Issue Prescription"}
                </button>
              </div>
            </form>
          </div>
      ...
      {showUploadLabModal && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#FFFFFF] border border-slate-200 rounded-3xl max-w-xl w-full p-6 shadow-2xl space-y-4 text-xs max-h-[90vh] overflow-y-auto">
            <div className="flex justify-between items-center border-b border-slate-200 pb-3">
              <h3 className="font-bold text-slate-900 text-base flex items-center space-x-2">
