  ...
  if (loading) {
    return (
      <div className="p-12 text-center text-slate-500 space-y-3">
        ...
        <p className="text-xs font-mono">Verifying PranaCrux Card Ledger & Token Security...</p>
      </div>
    );
  }
        ...
        <div className="lg:col-span-6 space-y-6">
          {!card || card.status === "NOT_ISSUED" || isLostOrRevoked(card.status) ? (
            <div className="bg-[#FFFFFF] border border-slate-200 rounded-3xl p-8 text-center space-y-4 shadow-xl">
              ...
              <div className="space-y-1">
                ...
                <p className="text-xs text-slate-500 max-w-sm mx-auto">
                  {isLostOrRevoked(card?.status)
                    ...
                    : "Issue your official PranaCrux Patient Access Card to enable effortless hospital visits without carrying a smartphone."}
                </p>
              ...
              >
                Issue PranaCrux Access Card Now
              </button>
            </div>
          ) : (
          ...
          <div className="bg-[#FFFFFF] border border-slate-200 rounded-2xl p-5 space-y-3">
            ...
            <p className="text-xs text-slate-700 leading-relaxed">
              When visiting any hospital or clinic, simply present your physical PranaCrux card. The doctor or reception staff scans your card, and a simple 1-click audio/visual confirmation screen will request your permission before displaying your records.
            </p>
        ...
        <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          ...
          >
            ...
            <div style={{ position: "absolute", bottom: "1.6mm", left: 0, right: 0, textAlign: "center", fontSize: "6.5px", color: "#9CA3AF", fontFamily: "monospace" }}>
              {card.cardIdentifier} • Scan QR at any PranaCrux-affiliated hospital
            </div>
          </div>
        </div>
      )}
